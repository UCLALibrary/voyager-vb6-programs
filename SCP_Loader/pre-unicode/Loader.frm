...
Private Sub Main()
    ...
    Set GL = New Globals
    GL.Init Command
'    GL.Init "-t ucla_testdb -f " & App.Path & "\mobile.001"
...
'Debug.Print RecordCount
        ...
        With MarcRecord
            ...
            .CharacterSetOut = "O"   'OCLC records
...
'        .SfdFindFirst "a"
'        If .SfdWasFound Then
'            F035 = Replace(.SfdText, "(OCoLC)", "")
'            .FldDelete
'            .FldAddGeneric "001", "", F035, 3
'        End If
'        Exit Do
'    End If
'    .FldFindNext "035"
...
'**** TEMP TO SUPPORT RELOAD OF REJECTS ****
            ...
            If .FldWasFound Then
                .SfdFindFirst "a"
                If .SfdWasFound Then
                    F599a = UCase(.SfdText) 'Upper case for later comparison
                Else 'Has 599, but not 599 $a
                    If IsSerial(BibLevel) Then
                        WriteRawRecord RejSerialFilename, RawRecord, RejSerialCount
                    Else
                        WriteRawRecord RejMonoFilename, RawRecord, RejMonoCount
            ...
            Else 'no 599 at all
                ...
                Else
                    WriteRawRecord RejMonoFilename, RawRecord, RejMonoCount
                End If
                WriteLog GL.Logfile, "No 599 field " & TranslateBibLevel(BibLevel) & " : " & F001
                GoTo MainLoop
            End If

            If IsSerial(BibLevel) = False And Lacks245h599b(MarcRecord) Then
                'Monos only
                WriteRawRecord RejMonoFilename, RawRecord, RejMonoCount
                WriteLog GL.Logfile, "No 245 $h and/or 599 $b " & TranslateBibLevel(BibLevel) & " : " & F001
                GoTo MainLoop
            End If
...
Private Function Lacks245h599b(ByVal BibRecord As Utf8MarcRecordClass) As Boolean
    ...
    Lacks245h599b = (Lacks245h And Lacks599b)
End Function
