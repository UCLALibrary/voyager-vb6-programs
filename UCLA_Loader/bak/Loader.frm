...
Private Sub Main()
    ...
    Set GL = New Globals
    GL.Init Command
'GL.Init "-t ucla_testdb -f " & App.Path & "\D090918.oclc"
...
Private Sub KeepOrReject(InputFilename As String)
    ...
    '       LDR/22 [994 $a, starting 20060926]
    ...
    WriteLog GL.Logfile, GetFileFromPath(InputFilename) & " split based on 049/079/994: Kept " & KeepCount & ", rejected " & RejectCount
...
'    Dim Has856 As Boolean
    ...
    With MarcRecord
        ...
        If .FldFindFirst("003") Then
            f003 = .FldText
            If f003 <> oclc Then
                WriteLog GL.Logfile, "Warning: Field 003 should be " & oclc & " but is " & f003
            End If
            .FldDelete
        End If
        
        f035 = .SfdMake("a", "(" & oclc & ")" & f001)
        ...
        If .FldFindFirst("019") Then
            ...
            Do While .SfdWasFound
                ...
                f035 = f035 & .SfdMake("z", "(" & oclc & ")" & f019a)
                OclcCnt = OclcCnt + 1
