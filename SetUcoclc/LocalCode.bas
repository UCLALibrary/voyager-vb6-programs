...
Public Sub RunLocalCode()
    ...
    '20121024 akohler: Select Distinct: some records have multiple 0350 OCOLC entries and were being handled redundantly
    '20130501 akohler: Moved SQL to external file for easier management / testing
